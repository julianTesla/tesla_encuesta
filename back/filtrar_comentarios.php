<?php
 ...
 AND resultados.fecha BETWEEN '$f1' AND '$f2' ORDER BY encuestas.id_encuesta DESC";*/
 ...
 else
 {
    ...
    <div class="container-fluid pt-4 px-4">
        <div class="bg-secondary rounded h-100 p-4">
            <div class="testimonial-item text-center">
                <div class="d-flex justify-content-between mb-2 " style="background-color: black; border-radius: 10px;">
