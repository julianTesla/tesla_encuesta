...
{}else{
    ...
    if (isset($_POST['respuesta1'])) {
        ...
        $sql1 ="INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`, `pregunta_id`) 
                VALUES ('$encuesta_id', '$curso_id',  0, '$respuesta_1', '$fecha', '$id_pregunta1')";
    ...
    if (isset($_POST['respuesta2'])) {
        ...
        $sql2 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`, `pregunta_id`) 
                 VALUES ('$encuesta_id', '$curso_id',  0, '$respuesta_2', '$fecha', '$id_pregunta2')";
    ...
    if (isset($_POST['respuesta3'])) {
        ...
        $sql3 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`, `pregunta_id`) 
                 VALUES ('$encuesta_id', '$curso_id',  0, '$respuesta_3', '$fecha', '$id_pregunta3')";
    ...
    if (isset($_POST['respuesta4'])) {
        ...
        $sql4 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`, `pregunta_id`) 
                 VALUES ('$encuesta_id', '$curso_id',  0, '$respuesta_4', '$fecha', '$id_pregunta4')";
    ...
    if (isset($_POST['respuesta5'])) {
        ...
        $sql5 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`, `pregunta_id`) 
                 VALUES ('$encuesta_id', '$curso_id', 0,  '$respuesta_5','$fecha', '$id_pregunta5')";
    ...
    if (isset($_POST['texto1'])){
        ...
        if($texto1 != false)
        {
            $sql_texto1 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`, `pregunta_id`) 
                           VALUES ('$encuesta_id', '$curso_id', '$texto1', 0, '$fecha', '$id_pregunta1')";
    ...
    if (isset($_POST['texto2'])) {
        ...
        if($texto2 != false)
        {
        $sql_texto2 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`, `pregunta_id`) 
                       VALUES ('$encuesta_id', '$curso_id', '$texto2', 0, '$fecha', '$id_pregunta2')";
    ...
    if (isset($_POST['texto3'])) {
        ...
        if($texto3 != false)
        {
        $sql_texto3 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`, `pregunta_id`) 
                       VALUES ('$encuesta_id', '$curso_id', '$texto3', 0, '$fecha', '$id_pregunta3')";
    ...
    if (isset($_POST['texto4'])) {
        ...
        if($texto4 != false)
        {
        $sql_texto4 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`, `pregunta_id`) 
                       VALUES ('$encuesta_id', '$curso_id', '$texto4',  0, '$fecha', '$id_pregunta4')";
    ...
    if (isset($_POST['texto5'])) {
        ...
        if($texto5 != false)
        {
        $sql_texto5 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`, `pregunta_id`) 
        VALUES ('$encuesta_id', '$curso_id', '$texto5', 0, '$fecha', '$id_pregunta5')";
