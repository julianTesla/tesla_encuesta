...
{}else{
    ...
    if (isset($_POST['respuesta1'])) {
        ...
        $sql1 ="INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`) 
                VALUES ('$encuesta_id', '$curso_id',  0, '$respuesta_1', '$fecha')";
    ...
    if (isset($_POST['respuesta2'])) {
        ...
        $sql2 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`) 
                 VALUES ('$encuesta_id', '$curso_id',  0, '$respuesta_2', '$fecha')";
    ...
    if (isset($_POST['respuesta3'])) {
        ...
        $sql3 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`) 
                 VALUES ('$encuesta_id', '$curso_id',  0, '$respuesta_3', '$fecha')";
    ...
    if (isset($_POST['respuesta4'])) {
        ...
        $sql4 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`) 
                 VALUES ('$encuesta_id', '$curso_id',  0, '$respuesta_4', '$fecha')";
    ...
    if (isset($_POST['respuesta5'])) {
        ...
        $sql5 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`) 
                 VALUES ('$encuesta_id', '$curso_id', 0,  '$respuesta_5','$fecha')";
    ...
    if (isset($_POST['texto1'])) {
        ...
        $sql_texto1 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`) 
                       VALUES ('$encuesta_id', '$curso_id', '$texto1', 0, '$fecha')";
    ...
    if (isset($_POST['texto2'])) {
        ...
        $sql_texto2 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`) 
                       VALUES ('$encuesta_id', '$curso_id', '$texto2', 0, '$fecha')";
    ...
    if (isset($_POST['texto3'])) {
        ...
        $sql_texto3 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`) 
                       VALUES ('$encuesta_id', '$curso_id', '$texto3', 0, '$fecha')";
    ...
    if (isset($_POST['texto4'])) {
        ...
        $sql_texto4 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`) 
                       VALUES ('$encuesta_id', '$curso_id', '$texto4',  0, '$fecha')";
    ...
    if (isset($_POST['texto5'])) {
        ...
        $sql_texto5 = "INSERT INTO `resultados` (`resultado_encuesta_id`, `resultado_curso_id`, `respuesta_text`, `respuesta_multiplechoice`, `fecha`) 
        VALUES ('$encuesta_id', '$curso_id', '$texto5', 0, '$fecha')";
