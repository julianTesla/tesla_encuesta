...
<div class="container-fluid pt-4 px-4">
    <div class="bg-secondary text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-around">
            ...
            <form action="./insertencuesta.php" method="get"><button type="submit" href="#" class="btn btn-primary d-flex align-items-center justify-content-between p-2" style="width: 160px;"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
