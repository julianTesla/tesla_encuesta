    ...
    <div class="container-fluid pt-4 px-4">
        <div class="bg-secondary text-center rounded p-4">
            ...
            <form action="/" method="GET">
                ...
                <form action="./asignarEncuesta.php?id_encuesta=<?php echo $row2['id_encuesta']; ?>" method="GET">
...
<script>
    let html ='<a href="Crear_encuesta.php" class="nav-item nav-link "><i class="far fa-file-alt me-2"></i>Crear encuesta</a>'+
                ...
                '<a href="listaEncuestas.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Lista de encuestas</a>'+
